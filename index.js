...
let allowedOrigins = ['http://localhost:8080', 'http://testsite.com', 'http://localhost:1234', 'https://my-awesome-movies.netlify.app', 'http://localhost:4200', 'https://mymovie-backend-api.herokuapp.com/users'];
app.use(cors({
