...
let allowedOrigins = ['http://localhost:8080', 'http://testsite.com', 'http://localhost:1234', 'https://my-awesome-movies.netlify.app', 'https://624b0be321937b090192e2e0--my-awesome-movies.netlify.app', 'http://localhost:4200', 'https://mymovie-backend-api.herokuapp.com/users', 'https://moni-tu.github.io/MyMovies-Angular-client/welcome', 'https://moni-tu.github.io'];
app.use(cors({
